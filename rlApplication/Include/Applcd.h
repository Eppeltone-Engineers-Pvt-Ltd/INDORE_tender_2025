...
#define HIGH_RESO_KVAH_1DEC_INDEX	0x23
...
#define TOD_kWH1		(uint8_t *)&InsSave.TODEnergy.TOD[0].kWh
#define TOD_kWH2		(uint8_t *)&InsSave.TODEnergy.TOD[1].kWh
#define TOD_kWH3		(uint8_t *)&InsSave.TODEnergy.TOD[2].kWh
#define TOD_kWH4		(uint8_t *)&InsSave.TODEnergy.TOD[3].kWh
#define TOD_kWH5		(uint8_t *)&InsSave.TODEnergy.TOD[4].kWh
#define TOD_kWH6		(uint8_t *)&InsSave.TODEnergy.TOD[5].kWh
#define TOD_kWH7		(uint8_t *)&InsSave.TODEnergy.TOD[6].kWh
#define TOD_kWH8		(uint8_t *)&InsSave.TODEnergy.TOD[7].kWh
