...
#define	OSD_FAIL_ACTION_DONE			0x08
...
#if (defined(IS_EXPORT_METER) && (IS_EXPORT_METER == 0))
	#define STRUCT_INSSAVE_SIZE 		244
	#define	PFAILSAVEDATA_LEN			40
#elif (defined(IS_EXPORT_METER) && (IS_EXPORT_METER == 1))
...
#define LS_EVENT_LENGTH          8U
#define LS_TOTAL_DAYS           70UL
