...
$ENDIF
$IFNDEF ASM_TARGET_BOARD_JABALPUR
ASM_TARGET_BOARD_JABALPUR	.EQU	1
ASM_TARGET_BOARD_INDORE	.EQU		1
$ENDIF


$IF (ASM_PCB_VER_4_6_8==1)
$IF (ASM_TARGET_BOARD_HPSEB==1)
FLASH_FW_VERSION:				.DB "4.68.709"
$ENDIF
$IF (ASM_TARGET_BOARD_WRANGAL==1)
FLASH_FW_VERSION:				.DB "4.68.500"
$ENDIF
$IF (ASM_TARGET_BOARD_JABALPUR==1)
$IF (ASM_TARGET_BOARD_INDORE==1)
;indore
FLASH_FW_VERSION:				.DB "4.68.807"
$ELSE
;jabalpur
FLASH_FW_VERSION:				.DB "4.68.616"
$ENDIF
$ENDIF
...
;#4
FLASH_LS_PERIOD:				.DB 0x02,0x04,0x00	;	900
;#5
