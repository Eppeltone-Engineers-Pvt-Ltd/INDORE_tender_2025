...
const class03_child_record_t g_ChildTableClass03[] =
{
	...
	/* 11 */ {	{   1,   0,   1,  29,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_WH, PHY_UNIT_WATT_HOUR		}	},	/* Block Energy ï¿½ kWh */
	/* 12 */ {	{   1,   0,   9,  29,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_VAH, PHY_UNIT_VOLT_AMPERE_HOUR	}	},	/* Block Energy ï¿½ kVAh */
...
//	/* 36 */ {	{   1,   0,   2,  29,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_WH	, PHY_UNIT_WATT_HOUR			}	},	/* Block Energy ï¿½ Export kWh */
	...
	/* 38 */ {	{   1,   0,  11,   27,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_AMPERE, PHY_UNIT_AMPERE				}	},	/* block avg Phase current  */
	#else
	/* 38 */ {	{   1,   0,  94,  91,  214, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_AMPERE	, PHY_UNIT_AMPERE			}	},	/* Avg block Current  */
	#endif
	...
	/* 40 */ {	{   1,   0,  91,   27,   0, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_AMPERE, PHY_UNIT_AMPERE				}	},	/* block avg Neutral current */
	///* 41 */ {	{   0,   0,  94,  91, 251, 255 }, (access_right_t *) g_AccessRightTable[0], DYN_VALUE(CHOICE_DOUBLE_LONG				, NULL								, ATTR_ACCESS_USERFUNC)	, {SCALAR_NULL, PHY_UNIT_NONE					}	}		/* cummulative billing tamper count */
...
//	/* 19 */ {	{   1,   0,  10,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy - Export kVAh*/
	/* 20 */ {	{   1,   0,  96,   5,   0, 255 }, 1			, 2			, 0		},	/* Selft diagnostic*/
	/* 21 */ {	{   0,   0,  96,   50,  9, 255 }, 3			, 2			, 0		}	/* bill day*/
...
const class07_capture_object_t g_Class07_BlockloadCaptureObjects[] =
{
	...
	/* 02 */ {	{   1,   0,  1,   29,   0, 255 }	, 3		, 2			, 0		},	/* Block Energy ï¿½ kWh  */
	#if (defined(IS_EFF_I_AVG) && (IS_EFF_I_AVG == 1))
	/* 03 */ {	{   1,   0,  94,  91,  214, 255 }	, 3		, 2			, 0		},	/* Avg Block Effective Current*/
	#elif (defined(IS_PHASE_I_AVG) && (IS_PHASE_I_AVG == 1))
	/* 03 */ {	{   1,   0,  11,   27,   0, 255 }	, 3		, 2			, 0		},	/* Avg Ph Block Current*/
	#else
		#error "avg current not defined."
	#endif	
	/* 04 */ {	{   1,   0,   1,   27,   0, 255 }	, 3		, 2			, 0		},	/* Block kW  */
	/* 05 */ {	{   1,   0,   9,  29,   0, 255 }	, 3		, 2			, 0		},	/* Block Energy ï¿½ kVAh  */
	#if (defined(IS_NU_I_AVG) && (IS_NU_I_AVG == 1))
	/* 06 */ {	{   1,   0,  91,   27,   0, 255}	, 3		, 2			, 0		},	/* Avg Nu Block Current*/
	#endif	
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
	/* 07 */ {	{   1,   0,  13,   27,   0, 255}	, 3		, 2			, 0		}	/* Avg Block Pf*/
	#endif
...
#if (defined(IS_NU_I_AVG) && (IS_NU_I_AVG == 1))
#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
const Unsigned8 PARA_RAM_SIZE_BLOCKLOAD[]={12,4,4,4,4,4,4,4};
#else
const Unsigned8 PARA_RAM_SIZE_BLOCKLOAD[]={12,4,4,4,4,4,4};
#endif
#else
#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
const Unsigned8 PARA_RAM_SIZE_BLOCKLOAD[]={12,4,4,4,4,4,4};
...
const class07_capture_object_t g_Class07_BlockloadCaptureObjects_Scaler[] =
{
	...
	/* 02 */ {	{   1,   0,  1,   29,   0, 255 }		, 3		, 3			, 0		},	/* Block Energy ï¿½ kWh  */
	#if (defined(IS_EFF_I_AVG) && (IS_EFF_I_AVG == 1))
	/* 03 */ {	{   1,   0,  94,  91,  214, 255 }		, 3		, 3			, 0		},	/* Block Avg Current */
	#elif (defined(IS_PHASE_I_AVG) && (IS_PHASE_I_AVG == 1))
	/* 03 */ {	{   1,   0,  11,   27,   0, 255 }		, 3		, 3			, 0		},	/* Avg Ph Block Current*/
	#else
		#error "avg current not defined."
	#endif	
	/* 04 */ {	{   1,   0,   1,   27,   0, 255 }		, 3		, 3			, 0		},	/* Block kW */
	/* 05 */ {	{   1,   0,  9,   29,   0, 255 }		, 3		, 3			, 0		},  /* Block Energy ï¿½ kVAh  */
	#if (defined(IS_NU_I_AVG) && (IS_NU_I_AVG == 1))
	/* 06 */ {	{   1,   0,  91,   27,   0, 255}		, 3		, 3			, 0		},	/* Avg Nu Block Current*/
	#endif
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
	/* 07 */ {	{   1,   0,  13,   27,   0, 255}		, 3		, 3			, 0		}	/* Avg Block Current*/
	#endif
};
...
const class07_capture_object_t g_Class07_DailyloadCaptureObjects[] =
{
	...
	/*----------------------------------------------------------------------------*/
	/* 00 */ {	{   0,   0,   1,   0,   0, 255 }, 8			, 2			, 0		},	/* Clock */
	/* 01 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy ï¿½ kWh */
	/* 02 */ {	{   1,   0,   9,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy ï¿½ kVAh */
	///* 03 */ {	{   1,   0,   2,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Export Energy ï¿½ kWh */	
};
...
const class07_capture_object_t g_Class07_DailyloadCaptureObjects_Scaler[] =
{
	...
	/*----------------------------------------------------------------------------*/
	/* 00 */// {	{   0,   0,   1,   0,   0, 255 }, 8			, 2			, 0		},	/* Clock */
	/* 01 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Energy ï¿½ kWh */
	/* 02 */ {	{   1,   0,   9,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Energy ï¿½ kVAh */
	///* 03 */ {	{   1,   0,   2,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Export Energy ï¿½ kWh */
};
...
const class07_capture_object_t g_Class07_BillingCaptureObjects[] =
{
	...
	/* 02 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy ï¿½ kWh */
	...
	/* 11 */ {	{   1,   0,   9,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy ï¿½ kVAh */
	...
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 0))
	/* 58 */ {	{   1,   0,  10,   8,   0, 255 }, 3			, 2			, 0		}	/* Cumulative Export Energy ï¿½ kVAh */
	#endif
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
	/* 58 */ {	{   1,   0,  10,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Export Energy – kVAh */
	/* 59 */ {	{   0,   0,  94,  91,   0, 255 }, 1			, 2			, 0		}	/* Billing Tamper count  */
	#endif
};
...
#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
const Unsigned8 PARA_RAM_SIZE_BILLING[]={12,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,12,4,12,4,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,12,4,4,4};
#else
...
const class07_capture_object_t g_Class07_BillingCaptureObjects_Scaler[] =
{
	...
	/* 02 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Energy ï¿½ kWh */
	...
	/* 09 */ {	{   1,   0,   9,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Energy ï¿½ kVAh */
	...
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 0))
	/* 46 */ {	{   1,   0,  10,   8,   0, 255 }, 3			, 3			, 0		}	/* Cumulative Export Energy ï¿½ kVAh */
	#endif
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))
	/* 46 */ {	{   1,   0,  10,   8,   0, 255 }, 3			, 3			, 0		},	/* Cumulative Export Energy – kVAh */
	/* 47 */{	{   0,   0,  94,  91,   0, 255 }, 2			, 3			, 0		}	/* billing Tamper count  */
	#endif
};
...
const class07_capture_object_t g_Class07_Event0CaptureObjects[] =
{
	...
	/* 02 */ {	{   1,   0,  11,   7,   0, 255 }, 3			, 2			, 0		},	/* Ph Current  */
	/* 04 */ {	{   1,   0,  12,   7,   0, 255 }, 3			, 2			, 0		},	/* Voltage  */
	/* 05 */ {	{   1,   0,  13,   7,   0, 255 }, 3			, 2			, 0		},	/* Signed Power Factor */
	/* 06 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 2			, 0		},	/* Cumulative Energy - kWh */
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))		
	/* 07 */ {	{   1,   0,  91,   7,   0, 255 }, 3			, 2			, 0		},	/* Nu Current  */
	#else
	/* 07 */ {	{   1,   0,   2,   8,   0, 255 }, 3			, 2			, 0		}	/* Cumulative Export Energy - kWh */
	#endif
	/* 08 */ {	{   1,   0,  94,  91,  14, 255 }, 3			, 2			, 0		}	/* Effective Current  */
...
const class07_capture_object_t g_Class07_Event1CaptureObjects[] =
{
	...
	///* 02 */ {	{   1,   0,  11,   7,   0, 255 }, 3			, 2			, 0		},	/* Current  */
...
const Unsigned8 PARA_RAM_SIZE_EVENT[]={12,2,4,4,4,4,4,4,4};
/* Capture object list */
const class07_capture_object_t g_Class07_Event0CaptureObjects_Scaler[] =
{
	...
	/* 02 */ {	{   1,   0,  11,   7,    0, 255 }, 3			, 3			, 0		},	/*  Ph Current  */
	/* 03 */ {	{   1,   0,  12,   7,   0, 255 }, 3			, 3			, 0		},		/* Voltage  */
	/* 04 */ {	{   1,   0,  13,   7,   0, 255 }, 3			, 3			, 0		},		/* Signed Power Factor */
	/* 05 */ {	{   1,   0,   1,   8,   0, 255 }, 3			, 3			, 0		},		/* Cumulative Energy - kWh */
	#if (defined(BOARD_TARGET_JABALPUR) && (BOARD_TARGET_JABALPUR == 1))		
	/* 07 */ {	{   1,   0,  91,   7,   0, 255 }, 3			, 3			, 0		},		/* Nu Current  */
	#else
	/* 07 */ {	{   1,   0,   2,   8,   0, 255 }, 3			, 3		, 0		},	/* Cumulative Export Energy - kWh */
	#endif
	/* 08 */ {	{   1,   0,  94,  91,  14, 255 }, 3			, 3			, 0		}	/* Effective Current  */
...
const schedule_table_entry_t  g_Class10_schedule_lists[] =
{
	...
	{   0,   0,   10,   0,   100, 255 },	/* The logical name of the ï¿½Script tableï¿½ object */
	...
	0x01,									/* Link to the IC ï¿½Special days tableï¿½, day_id; */
...
const spec_day_entry_t  g_Class11_spec_day_lists[] =
{
	...
	0x01,									/* exec_specdays in the related object of IC ï¿½Scheduleï¿½ */
	},
};
...
#if (defined(EEPL_NUMBER_OF_SEASON) && (EEPL_NUMBER_OF_SEASON==1))
...
#elif (defined(EEPL_NUMBER_OF_SEASON) && (EEPL_NUMBER_OF_SEASON==2))
const class20_child_record_t g_ChildTableClass20[] =
{
	/* Activity calendar */
	{
...
{
	/*----------------------------------------------------*/
	/*  ï¿½Script tableï¿½ logical name  | Script_identifier  */
	/*----------------------------------------------------*/
...
{
	/*--------------------------------------------------------------------*/
	/*  logical name of the ï¿½Script tableï¿½ object | Script_identifier     */
	/*--------------------------------------------------------------------*/
