...
//------------------class 3 new way access-----------------
#if (defined(USED_CLASS_03) && USED_CLASS_03 == 1)

const uint8_t class03ParamID[]={
EM_VOLTAGE,
EM_PHASE_CURRENT,
EM_NEUTRAL_CURRENT,
EM_POWER_FACTOR,
...
EM_APPARENT_POWER,
EM_ACTIVE_POWER,
EM_CUCUMLARIVE_ENERGY_KWH,
EM_CUCUMLARIVE_ENERGY_KVAH,
EM_CUCUMLARIVE_POWER_ON_DURATION,
EM_AVERAGE_VOLTAGE,
EM_BLOCK_ENERGY_KWH,
EM_BLOCK_ENERGY_KVAH,
EM_LASTBILLING_TIME,
EM_AVERAGE_POWER_FACTOR,
EM_CUCUMLARIVE_ENERGY_KWH_TZ1,
EM_CUCUMLARIVE_ENERGY_KWH_TZ2,
EM_CUCUMLARIVE_ENERGY_KWH_TZ3,
EM_CUCUMLARIVE_ENERGY_KWH_TZ4,
EM_CUCUMLARIVE_ENERGY_KWH_TZ5,
EM_CUCUMLARIVE_ENERGY_KWH_TZ6,
EM_CUCUMLARIVE_ENERGY_KWH_TZ7,
EM_CUCUMLARIVE_ENERGY_KWH_TZ8,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ1,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ2,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ3,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ4,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ5,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ6,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ7,
EM_CUCUMLARIVE_ENERGY_KVAH_TZ8,
EM_CURRENT,
EM_POWER_ON_DURATION,
EM_CUCUMLARIVE_EXP_ENERGY_KWH,
EM_CUCUMLARIVE_EXP_ENERGY_KVAH,
EM_PRE_BILL_DATE_READ,
EM_BLOCK_ENERGY_KWH_EXP,
EM_BLOCK_AVG_PF,
EM_BLOCK_AVG_CURRENT,
EM_BLOCK_AVG_LOAD,
EM_BLOCK_AVG_NU_CURRENT
};
#endif
...
const scaler_unit_t		g_Class07_BlockloadScalerBuffer[] =
{
	...
	{SCALAR_LS_WH, PHY_UNIT_WATT_HOUR				},	/* Block Energy � kWh 	*/
	...
	{SCALAR_VOLTAGE, PHY_UNIT_AMPERE			},	/* Block Avg Current 	*/
	#endif
	{SCALAR_LS_WATT, PHY_UNIT_WATT				},	/* Avg Load 			*/
	{SCALAR_LS_VAH, PHY_UNIT_VOLT_AMPERE_HOUR	},	/* Block Energy - kVAh	*/
...
const scaler_unit_t		g_Class07_Event0ScalerBuffer[] =
{
	...
	{SCALAR_AMPERE, PHY_UNIT_AMPERE			},	/* ph Current  */
	{SCALAR_VOLTAGE, PHY_UNIT_VOLT			},	/* Voltage  */
	{SCALAR_APF, PHY_UNIT_NONE				},	/* Signed Power Factor */
	{SCALAR_WH, PHY_UNIT_WATT_HOUR			},	/* Cumulative Energy - kWh */
	{SCALAR_AMPERE, PHY_UNIT_AMPERE			},	/* neutral current */
	{SCALAR_AMPERE, PHY_UNIT_AMPERE			},	/* effective current */
...
//			Unsigned16 u16;
			...
			/* Get the buffer pointer */
			/* Get the buffer pointer */
			if(child_id>=0&& child_id<=40 )
			{
				if(child_id==13)
				{
					Unsigned8 rlt;
					/* Get time */
					rlt = R_USER_GetSpecificTime(class03ParamID[child_id], &temp_time);
				...
				{
					temp_f32 = R_USER_GetEMData(class03ParamID[child_id]);
